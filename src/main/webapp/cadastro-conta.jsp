			...
			<div class="container">
				...
				<div class="signup-content">
					<div class="signup-form">
						<h2 class="form-title">Cadastrar conta bancária</h2>
						...
						<form method="post" action="conta" class="register-form"
							...
							<div class="form-group">
								<label for="agencia"><i
									...
									type="text" name="agencia" id="agencia" placeholder="Agencia" />
							</div>
							<div class="form-group">
								<label for="tipo"><i class="zmdi zmdi-lock-outline"></i></label>
